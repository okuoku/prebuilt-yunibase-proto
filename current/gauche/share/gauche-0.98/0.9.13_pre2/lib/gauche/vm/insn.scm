...
(make <vm-insn-info> :name 'EXTEND-DENV :code 238
  ...
  :fold-lref #f
  :combined '#f
  :body '(let* ((arg) (next::ScmWord*)) (SCM_FLONUM_ENSURE_MEM VAL0) (POP-ARG arg) (FETCH-LOCATION next) INCR_PC (PUSH-CONT next) (Scm_VMPushDynamicEnv arg VAL0) NEXT))
...
(make <vm-insn-info> :name 'TAIL-EXTEND-DENV :code 239
  ...
  :fold-lref #f
  :combined '#f
  :body '(let* ((arg)) (SCM_FLONUM_ENSURE_MEM VAL0) (POP-ARG arg) (Scm_VMPushDynamicEnv arg VAL0) NEXT))
